...
(async () => {
  try {
    const editionDropAddress = await sdk.deployer.deployEditionDrop({
      ...
      description: "A DAO for Hatakeyama Takashi",
      // コレクションのアイコンとなる画像（ローカルの画像を参照すること）
      image: readFileSync("src/scripts/assets/dog.png"),
...
//editionDrop contract, address: 0xF07B1F01B92E5Bd1AF788A90a6c7585DdA88B50e